...
```{r echo=FALSE}
knitr::include_graphics("tree2.svg")
```
...
[minisvg_with_tree.svg](minisvg_with_tree.svg), where I copy-pasted the single
elements of the [tree2.svg](tree2.svg) file into the hex svg. It has some
bizarre unintentional effects, but looks interesting though. 
